...
a time.  The user's package universe provides context which in turn
simplifies many aspects of package distribution.  The main cost of
this approach is that content must be repackaged for each universe
...
form of content, e.g. software, media components, or written essays.
