...
Definitions and declarations of have the highest precedence, no matter
whether they are local or inherited. Explicit imports have the next
highest precedence and wildcard imports have the third highest
precedence.  A definition made available by a package clause also has
highest precedence together with the other forms of definitions, but
only in the compilation unit where the definition occurs. In all other
compilation units such a definition has lowest precedence.
