...
declaraton in a structural refinement, the type of any value parameter may only refer
...
\example When typing \@sort(xs)@ for some list \@xs@ of type \@List[List[List[Int]]]@, 
...
\example Let \@ys@ be a list of some type which cannot be converted
