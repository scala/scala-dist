...
The regions where newlines are enabled are:
\begin{enumerate}
\item
...
The regions where newlines are suppressed are:
\begin{enumerate}
\item
The interval between matching \lstinline@(@ and \lstinline@)@ parenthesis tokens, except for nested regions where newlines are enabled.
\item
...
consisting of the value denoted by $p$. It is 
...
Typing of literals is as described in \label{sec:literals}; their
