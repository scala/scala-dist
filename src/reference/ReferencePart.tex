...
expression is the least upper bound of the types of $e_2$ and
...
$B$ if $A$ is as specific as $B$, and, if $B$ is also as specific as $A$, then
$A$ is defined in a proper subclass of $B$. 
