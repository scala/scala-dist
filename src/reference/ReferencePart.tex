...
An annotated type ~\lstinline^@$a_1$ $\ldots$ @$a_n$ $T$^wq
...
function declaration, the type of any value parameter must not refer
to a type parameter of this same function. If no refinement is given,
