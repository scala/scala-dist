...
\begin{itemize} 
\item
A parameterized method $m$ of type \lstinline@($p_1:T_1\commadots p_n:T_n$)$U$@ is as specific as some other
...
$B$ if $A$ is as specific as $B$, and $B$ is not also as specific as $A$.
