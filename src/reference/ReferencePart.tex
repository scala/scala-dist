...
by value definitions of non-volatile types (\sref{sec:volatile-types}).
\item
...
\item 
If neither $T$ nor $U$ are parameterized method types then $T$ is more specific than $U$
if the existential dual of $T$ conforms to the existential dual of $U$. 
