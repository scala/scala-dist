...
occurs in a context where a singleton type is required is the
singleton type \lstinline@$p$.type@.

The contexts where a singleton type is required are those that satisfy
...
\item
The expected type $\proto$ is a singleton type, or
\item
The expected type $\proto$ is an abstract type with a singleton type as lower
...
\centering
\includegraphics[scale=0.40]{../../papers/overview/images/classhierarchy}
\vspace*{-1.5mm}
