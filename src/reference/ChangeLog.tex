...
Protected members can now have a visibility quialifier (\sref{sec:modifiers}),
e.g. \lstinline@protected[<qulaifier>]@. In particular, one can now
...
by some part of $T$, 
or if it is a baseclass of some part of $T$. 
