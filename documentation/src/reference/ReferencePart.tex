...
If $T_i$ is a call-by-name parameter type, the value definition $y_i$
has the form \lstinline@val $y_i$ = () => $e_i$@ and the corresponding
argument expression for $e'$ is \lstinline@$y_i$()@.
